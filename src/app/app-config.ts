...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'School-IMS',                                        // App Name
    appTitle    : 'School-IMS - School Information Management System', // App Title
    appLogoImage: 'assets/images/logo/pyakasaloginlogo.png',                  // App Logo
