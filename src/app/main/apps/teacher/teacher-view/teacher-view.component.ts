...
import { TeacherViewService } from 'app/main/apps/teacher/teacher-view/teacher-view.service';
import { Teacher } from '@fake-db/teachers.data';
...
// import { id } from '@fake-db/teachers.data';
...
export class TeacherViewComponent implements OnInit, OnDestroy {
   ...
   *
   * @param {Router} router
   * @param {TeacherViewService} _teacherViewService
   * @param {CoreConfigService} _coreConfigService
   * @param {CalendarService} _calendarService
   * @param {ResultListService} _resultListService
   */
  constructor(private router: Router, private _teacherViewService: TeacherViewService, private route: ActivatedRoute, private _teachersListServe: TeacherListService,private _resultListService: ResultListService, private _coreConfigService: CoreConfigService) {
  ...
  ngOnInit(): void {
    // get user info by id
    // this._teachersListServe.getDataTableRows().subscribe(
    //   ({ data }) => this.teachers = data,
    // );
    this._teacherViewService.onTeacherViewChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
      this.data = response;
    });
